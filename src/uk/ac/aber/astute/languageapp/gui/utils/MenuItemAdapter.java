 ...
 * @see Appearance
 */
public class MenuItemAdapter implements ListAdapter { 
	 ...
	 *                   items should look. 
	 */
	public MenuItemAdapter(Context context, ArrayList<AppMenuItem> items, 
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		title.setTextColor(this.appearance.getMainFontColour());
		title.setTextSize(this.appearance.getMainFontSize());
		subtext.setTextColor(this.appearance.getSubFontColour());
		...
		rowView.setBackgroundColor(this.appearance.getCellColour());
